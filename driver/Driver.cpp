...
// The real CPipeServer.cpp is dropped from the project (compat/CPipeServer.h is a
// no-op stub that declares `extern CPipeServer g_pipe;`). Define the single global
// instance here so every g_pipe.* call site links.
CPipeServer g_pipe;
