...
- **⛔ FINAL VERDICT (2026-06) — a custom WDDM display driver is NOT achievable on this Qubes/Xen Win10 HVM.** All four routes are walled off, see `docs/findings.md` "FINAL VERDICT":
